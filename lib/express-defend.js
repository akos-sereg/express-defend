...
module.exports = {
	...
	suspiciousUrlFragments: [
		{ category: 'Path Traversal', patterns: ['../', '/etc/hosts', '/etc/passwd', '/etc/shadow'] }, 
		{ category: 'Reflected XSS', patterns: ['<script', '\\x3cscript', '%3cscript', 'alert(', 'console.log', 'onclick', 'onerror', 'onmouseover', 'onload'] },
		{ category: 'SQL Injection', patterns: ['\' or \'1\'=\'1', '" or "1"="1'] }
	],
